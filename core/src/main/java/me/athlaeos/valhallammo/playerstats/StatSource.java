...
public interface StatSource {
     ...
     * @param primaryItem the primary item involved, typically means the entity's currently used hand
     * @param use whether the stat is only meant for display purposes or actual physical execution
     * @return the stat to return
     */
    double fetch(Entity statPossessor, ItemBuilder primaryItem, boolean use);
}
